...
app.use(express_1.default.json()); // Essencial para ler o corpo da requisição (JSON)
...
app.get('/health', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                res.status(500).json({ error: "Erro ao ligar à base de dados", detalhes: error_1 });
                return [3 /*break*/, 3];
...
app.get('/dashboard/stats', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), livros = _a[0], alunos = _a[1], emprestimos = _a[2];
                res.json({ livros: livros, alunos: alunos, emprestimos: emprestimos });
                return [3 /*break*/, 3];
            case 2:
                error_2 = _b.sent();
